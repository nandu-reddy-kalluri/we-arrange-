...
export function Footer() {
  ...
  return (
    <footer className="relative w-full bg-[#120004] overflow-hidden pt-16 pb-8 flex flex-col justify-between max-h-[400px]">
      
      {/* Huge Background Watermark */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 font-serif font-black text-[300px] md:text-[350px] leading-none text-white opacity-[0.03] pointer-events-none select-none z-0 whitespace-nowrap">
        YW
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 w-full flex flex-col items-center h-full relative z-10">
        ...
        <div className="relative flex flex-col items-center mb-8 group">
          ...
          <motion.div
            ...
            className="relative"
          >
            <span className="font-serif text-[40px] md:text-[52px] font-bold text-white tracking-tight leading-none drop-shadow-[0_0_20px_rgba(200,155,60,0.3)] block text-center">
              YouMarriage
            </span>
          </motion.div>
        </div>
        ...
        <motion.div
          ...
          className="mb-12"
        >
          <span className="font-serif italic text-lg md:text-xl text-[#C89B3C] text-center block">
            Your celebration begins with the right choices.
          </span>
        </motion.div>

        {/* Thin Champagne Divider */}
        <div className="w-full max-w-md h-[1px] bg-gradient-to-r from-transparent via-[#C89B3C]/30 to-transparent mb-10" />

        {/* BOTTOM: Navigation & Socials */}
        <div className="flex flex-col md:flex-row items-center justify-between w-full mt-auto gap-8 md:gap-0">
