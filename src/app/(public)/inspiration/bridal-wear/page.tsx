...
const config = SUBSECTION_CONFIGS["bridal-wear"];
const items = SUBSECTION_ITEMS.filter(i => i.categorySlug === "bridal-wear");
...
export default function BridalWearPage() {
  const breadcrumbJsonLd = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 3, "name": config.title, "item": "https://www.youmarriagewearrange.com/inspiration/bridal-wear" }
    ]
  };
