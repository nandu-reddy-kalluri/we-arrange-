...
const config = SUBSECTION_CONFIGS["decor"];
const items = SUBSECTION_ITEMS.filter(i => i.categorySlug === "decor");

export const metadata: Metadata = {
  title: `${config.title} | YouMarriageWeArrange`,
  description: config.description,
  alternates: {
    canonical: `https://www.youmarriagewearrange.com/inspiration/decor`
  },
  openGraph: {
    title: `${config.title} | YouMarriageWeArrange`,
    description: config.description,
    type: "website",
    url: `https://www.youmarriagewearrange.com/inspiration/decor`,
...
export default function DecorPage() {
  const breadcrumbJsonLd = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 3, "name": config.title, "item": "https://www.youmarriagewearrange.com/inspiration/decor" }
    ]
  };
